...
/************* Authorizer Configuration ***********/
  ...
  val ListenerSecurityProtocolMap: String = EndPoint.DefaultSecurityProtocolMap.map {
...
/***************** rack configuration **************/
  ...
  private def getInterBrokerListenerNameAndSecurityProtocol: (ListenerName, SecurityProtocol) = {
    Option(getString(KafkaConfig.InterBrokerListenerNameProp)) match {
      ...
      case None =>
        val securityProtocol = getSecurityProtocol(
  ...
  private def validateValues() {
    ...
    require(
      interBrokerProtocolVersion.messageFormatVersion.value >= messageFormatVersion.value,
